...
export default function VideoDetail() {
  const [videoDetail, setVideoDetail] = useState([]); // Null for initial state
  const [videos, setVideos] = useState([]);

  const { videoId } = useParams(); // Correct useParams
  ...
  if (!videoDetail) return <div>
    <div className="text-center mt-24 dark:bg-black bg-white">
      <div role="status">
  ...
  return (
    <div className='flex xl:flex-row flex-col gap-4 dark:bg-black h-screen bg-white text-white px-12'>
      <div className="lg:h-[90vh] dark:bg-black bg-white">
        ...
        <div className="p-4">
          <h2 className="md:text-2xl flex dark:text-white text-black text-xl">
      ...
      <div className='w-full dark:bg-black bg-white h-auto lg:overflow-y-auto'>
